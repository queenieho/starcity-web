$(document).ready(function() {
  ...
  function makeInteriorWall(canvas, interiorWalls, interiorWallStyle) {
    ...
    interiorWalls.forEach(function(item) {
  ...
  function makeNightTable(canvas, nightTables, nightTableStyle, labelStyle) {
    ...
    nightTables.forEach(function(item) {
  ...
  function makeSlidingDoor(canvas, slidingDoors, slidingDoorStyle, doorProjStyle) {
    ...
    slidingDoors.forEach(function(item) {
  ...
  function makeDresser(canvas, dressers, dresserStyle, labelStyle) {
    ...
    dressers.forEach(function(item) {
  ...
  if ($('#nott-floor1').length) {
    ...
    var nbWalls = getFeature(nbFloorOne.features, 'interiorWall');
    nbWalls = makeInteriorWall(canvas1, nbWalls, style.interiorWallStyle.default);
    var nbWin = getFeature(nbFloorOne.features, 'window');
    nbWin = makeWindows(canvas1, nbWin, style.windowStyle.default);
    var nbDoor = getFeature(nbFloorOne.features, 'door');
    ...
    var nbSliding = getFeature(nbFloorOne.features, 'slidingDoor');
    ...
    var stairs1 = getFeature(nbOneWall.features, 'stairs');
    ...
    var bedOneWindow = getFeature(nbOneBed1.features, 'window');
    bedOneWindow = makeWindows(canvas1, bedOneWindow, style.windowStyle.default);
    var bedOneDoor = getFeature(nbOneBed1.features, 'door');
    ...
    var laundryDoor = getFeature(nbOneLaundry.features, 'door');
    ...
    var toiletWindow = getFeature(nbOneToilet.features, 'window');
    toiletWindow = makeWindows(canvas1, toiletWindow, style.windowStyle.default);
    var toiletDoor = getFeature(nbOneToilet.features, 'door');
    ...
    var bathWindow = getFeature(nbOneBath.features, 'window');
    bathWindow = makeWindows(canvas1, bathWindow, style.windowStyle.default);
    var bathDoor = getFeature(nbOneBath.features, 'door');
    ...
    var stoDoor = getFeature(nbOneStorage.features, 'door');
    ...
    var bedTwoWindow = getFeature(nbOneBed2.features, 'window');
    bedTwoWindow = makeWindows(canvas1, bedTwoWindow, style.windowStyle.default);
    var bedTwoDoor = getFeature(nbOneBed2.features, 'door');
    ...
    var foyerWindow = getFeature(nbOneFoyer.features, 'window');
    foyerWindow = makeWindows(canvas1, foyerWindow, style.windowStyle.default);
    var foyerDoor = getFeature(nbOneFoyer.features, 'door');
  ...
  if ($('#nott-floor2').length) {
    ...
    var intWall1 = getFeature(nbTwoWall.features, 'interiorWall');
    intWall1 = makeInteriorWall(canvas2, intWall1, style.interiorWallStyle.default);
    var stairs2 = getFeature(nbTwoWall.features, 'stairs');
    ...
    var twoBed1Window = getFeature(nbTwoBed1.features, 'window');
    twoBed1Window = makeWindows(canvas2, twoBed1Window, style.windowStyle.default);
    var twoBed1Door = getFeature(nbTwoBed1.features, 'door');
    ...
    var twoBed2Window = getFeature(nbTwoBed2.features, 'window');
    twoBed2Window = makeWindows(canvas2, twoBed2Window, style.windowStyle.default);
    var twoBed2Door = getFeature(nbTwoBed2.features, 'door');
    ...
    var twoBed3Window = getFeature(nbTwoBed3.features, 'window');
    twoBed3Window = makeWindows(canvas2, twoBed3Window, style.windowStyle.default);
    var twoBed3Door = getFeature(nbTwoBed3.features, 'door');
    ...
    var twoShowerWindow = getFeature(nbTwoShower.features, 'window');
    twoShowerWindow = makeWindows(canvas2, twoShowerWindow, style.windowStyle.default);
    var twoShowerDoor = getFeature(nbTwoShower.features, 'door');
    ...
    var twoToiletWindow = getFeature(nbTwoToilet.features, 'window');
    twoToiletWindow = makeWindows(canvas2, twoToiletWindow, style.windowStyle.default);
    var twoToiletDoor = getFeature(nbTwoToilet.features, 'door');
    ...
    var twoBathWindow = getFeature(nbTwoBath.features, 'window');
    twoBathWindow = makeWindows(canvas2, twoBathWindow, style.windowStyle.default);
    var twoBathDoor = getFeature(nbTwoBath.features, 'door');
    ...
    var twoBed4Window = getFeature(nbTwoBed4.features, 'window');
    twoBed4Window = makeWindows(canvas2, twoBed4Window, style.windowStyle.default);
    var twoBed4Door = getFeature(nbTwoBed4.features, 'door');
    ...
    var twoBed5IntWall = getFeature(nbTwoBed5.features, 'interiorWall');
    twoBed5IntWall = makeInteriorWall(canvas2, twoBed5IntWall, style.interiorWallStyle.default);
    var twoBed5Window = getFeature(nbTwoBed5.features, 'window');
    twoBed5Window = makeWindows(canvas2, twoBed5Window, style.windowStyle.default);
    var twoBed5Door = getFeature(nbTwoBed5.features, 'door');
  ...
  if ($('#nott-floor3').length) {
    ...
    var intWall3 = getFeature(nbThreeWall.features, 'interiorWall');
    intWall3 = makeInteriorWall(canvas3, intWall3, style.interiorWallStyle.default);
    var stairs3 = getFeature(nbThreeWall.features, 'stairs');
    ...
    var threeBed1Window = getFeature(nbThreeBed1.features, 'window');
    threeBed1Window = makeWindows(canvas3, threeBed1Window, style.windowStyle.default);
    var threeBed1Door = getFeature(nbThreeBed1.features, 'door');
    ...
    var threeBed2Win = getFeature(nbThreeBed2.features, 'window');
    var threeBed2Door = getFeature(nbThreeBed2.features, 'door');
    ...
    var threeBed3Win = getFeature(nbThreeBed3.features, 'window');
    var threeBed3Door = getFeature(nbThreeBed3.features, 'door');
    ...
    var threeShowerWin = getFeature(nbThreeShower.features, 'window');
    var threeShowerDoor = getFeature(nbThreeShower.features, 'door');
    ...
    var threeToiWin = getFeature(nbThreeToilet.features, 'window');
    var threeToiDoor = getFeature(nbThreeToilet.features, 'door');
    ...
    var threeBathWin = getFeature(nbThreeBath.features, 'window');
    var threeBathDoor = getFeature(nbThreeBath.features, 'door');
    ...
    var threeBed4Win = getFeature(nbThreeBed4.features, 'window');
    var threeBed4Door = getFeature(nbThreeBed4.features, 'door');
    ...
    var threeBed5Win = getFeature(nbThreeBed5.features, 'window');
    var threeBed5Door = getFeature(nbThreeBed5.features, 'door');
